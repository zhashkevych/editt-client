                ...
                <div class="column for-creators">
                    ...
                    <div class="benefits">
                        <ul class="benefits-list">
                            ...
                            <li>Створення лояльної аудиторії та<br>розвиток особистого бренду <strong><i>(Незабаром)</i></strong></li>
                            <li>Можливості для монетизації власної творчості <strong><i>(Незабаром)</i></strong></li>
                        </ul>
                    </div>
